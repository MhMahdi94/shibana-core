...
@section('content')
    <div class="panel">
        <div class="mb-5 flex items-center justify-between">
            <h5 class="text-lg font-semibold dark:text-white-light">Meals Table</h5>
                    ...
                    @foreach ($meals as $meal)
                        <tr>
                            <td> <img class="flex-none w-16 h-16 rounded-full overflow-hidden object-cover"
                                    src="{{ url('uploads/meals/' . $meal->image) }}" alt="image" /></td>
                            <td class="">

                                <span class="flex-1 text-lg font-semibold text-orange"> {{ $meal->name }}</span>
                            ...
                            <td class="text-center">
                                <a href="{{ route('admin.meals.meals_edit', $meal->id) }}" type="button"
                                    x-tooltip="Edit">
                                ...
                                <button type="button" class="delete-btn" x-tooltip="Delete"
                                    data-route="{{ route('admin.meals.meals_destroy', $meal->id) }}"
                                    @click="showAlert({{ $meal->id }})">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
