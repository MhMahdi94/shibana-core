...
<body x-data="main" class="relative overflow-x-hidden font-nunito text-sm font-normal antialiased"
    ...
    <div
        ...
        <svg width="64" height="64" viewBox="0 0 135 135" xmlns="http://www.w3.org/2000/svg" fill="#B23F18">
            <path
    ...
    <div class="main-container min-h-screen text-black dark:text-white-dark">
        <div x-data="auth">
            <div class="absolute inset-0 bg-orange">
            ...
            <div
                ...
                <div
                    ...
                    <div
                        class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[400px] py-10">
                                        ...
                                        <li>
                                            <a href="javascript:;" class="hover:text-primary"
                                                ...
                                                {{-- <img
                                                        ...
                                                        :src="{{ asset(`assets/images/flags/$item.value.toUpperCase().svg`) }}"
                                                        alt="image"
                                                    /> --}}
                        ...
                        <div class="mx-auto w-full max-w-[440px]">
                            <div class="mb-10">
                                <img src="{{ asset('assets/images/logo.png') }}" width="200" class="mx-auto "
                                    alt="">
                                <h1 class="text-3xl font-extrabold uppercase !leading-snug text-brown md:text-4xl ">Sign
                                    in</h1>
                                <p class="text-base font-bold leading-normal text-orange text-white-dark">Enter your
                                    email and password to login</p>
                            </div>
                            {{-- {{Session::get('alert-type', 'info') }} --}}
                            <form class="space-y-5 dark:text-white" method="POST" action="{{ route('admin.admin.login') }}">
                                @csrf
                                <div>
                                    <label for="Email text-soft-black">Email</label>
                                ...
                                <div>
                                    <label for="Password text-soft-black ">Password</label>
                                    <div class="relative text-white-dark">
                                ...
                                <button type="submit"
                                    class="btn btn-orange !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]">
                                    Sign in
                                </button>
                            </form>
