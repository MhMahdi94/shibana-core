...
@section('content')
    <div class="panel">
        <div class="mb-5 flex items-center justify-between">
            <h5 class="text-lg font-semibold dark:text-white-light">Addons Table</h5>
            <a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600"
                href="{{ route('admin.addons.addons_create') }}">
            ...
            <table>
                ...
                <tbody>
                    @foreach ($addons as $addon)
                        <tr>
                            <td class="whitespace-nowrap">{{ $addon->name }}
                            </td>


                            <td>{{ $addon->restuarant->name}}
                            ...
                            <td class="text-center">
                                <a href="{{ route('admin.addons.addons_edit', $addon->id) }}" type="button"
                                    x-tooltip="Edit">
                                ...
                                <button type="button" class="delete-btn" x-tooltip="Delete"
                                    data-route="{{ route('admin.addons.addons_destroy', $addon->id) }}"
                                    @click="showAlert({{ $addon->id }})">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
    ...
    <script>
        async function showAlert(id, token) {
            ...
            new window.Swal({
                icon: 'question',
                title: 'Delete Addon',
                confirmButtonText: 'Delete this addon?',
